    ...
    <>
      ...
      >
        <Avatar
          ...
          src={getImageUrl(profile?.tp_image) || '/images/avatars/1.png'}
              ...
              <ClickAwayListener onClickAway={e => handleDropdownClose(e)}>
                <MenuList>
                  <div className='flex items-center plb-2 pli-6 gap-2' tabIndex={-1}>
                    <Avatar alt={user?.user_email || 'User'} src={getImageUrl(profile?.tp_image) || '/images/avatars/1.png'} />
                    <div className='flex items-start flex-col'>
                      <Typography className='font-medium' color='text.primary'>
                        {user?.user_email || 'User'}
                      </Typography>
                      <Typography variant='caption'>{user?.user_role?.role_name || 'User'}</Typography>
                    </div>
                  </div>
